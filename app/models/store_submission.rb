class StoreSubmission < ActiveRecord::Base
  ...
  attr_accessible :artist_id, :title, :description, :quantity, :quantity_accepted, :accepted, :image, :type, :type_other, :price, :height, :width, :depth, :h_unit, :w_unit, :d_unit, :presentation, :presentation_other, :provide_display, :notes, :dimension, :visual_submission_id, :admin_notes, :quantity_received, :quality, :quality_notes, :display_included, :display_notes, :packing_material, :packing_material_notes, :received
